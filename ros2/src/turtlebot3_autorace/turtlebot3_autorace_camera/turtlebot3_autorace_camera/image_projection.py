...
class ImageProjection(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameters(
            namespace='',
            parameters=[
                ('camera.extrinsic_camera_calibration.top_x', 120, parameter_descriptor_top),
                ('camera.extrinsic_camera_calibration.top_y', 120, parameter_descriptor_top),
                ('camera.extrinsic_camera_calibration.bottom_x', 320, parameter_descriptor_bottom),
                ('camera.extrinsic_camera_calibration.bottom_y', 320, parameter_descriptor_bottom),
